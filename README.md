...
With this mod you can rename planets.
...
The config file is used to store the planet names.  This will ensure you are able to disable this mod and now have issues with your save file.
